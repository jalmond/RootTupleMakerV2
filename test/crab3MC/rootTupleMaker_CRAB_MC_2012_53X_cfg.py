...
process.smearedAnalysisPatJets = cms.EDProducer("SmearedPATJetProducer",
                                                src = cms.InputTag('analysisPatJetsAK5PF'),
...
process.rootTupleMuons.InputTag = cms.InputTag('cleanPatMuons')
process.rootTupleMuons.InputTagEnUp  = cms.InputTag('muonsEnUp')
process.rootTupleMuons.InputTagEnDown  = cms.InputTag('muonsEnDown')

process.rootTupleElectrons.InputTag = cms.InputTag('cleanPatElectrons')
process.rootTupleElectrons.InputTagEnUp = cms.InputTag('electronsEnUp')
process.rootTupleElectrons.InputTagEnDown = cms.InputTag('electronsEnDown')
