def make_submitfile(jobid, dataset, dataset_postfix, version, tag):
    ...
    config+="config.JobType.psetName = 'rootTupleMaker_CRAB_MC_2012_53X_cfg.py'\n"
    config+="\n"
    ...
    config+='config.Data.unitsPerJob = 1\n'
    ...
    config+="config.Site.blacklist = ['T2_ES_IFCA','T2_IT_Legnaro']\n"
