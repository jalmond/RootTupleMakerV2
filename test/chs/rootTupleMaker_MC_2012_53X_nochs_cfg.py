...
process.patJetCorrFactorsAK5PF.useRho = cms.bool(True)
process.patJetCorrFactorsAK5PF.payload = cms.string('AK5PF')
...
#process.rootTuplePFJets.InputTag = cms.InputTag('cleanPatJetsAK5PF')
...
process.rootTuplePFJets.InputTagSmearedUp = cms.InputTag('analysisPatJetsAK5PF')
process.rootTuplePFJets.InputTagSmearedDown = cms.InputTag('analysisPatJetsAK5PF')
process.rootTuplePFJets.InputTagScaledUp    = cms.InputTag('analysisPatJetsAK5PF')
process.rootTuplePFJets.InputTagScaledDown  =  cms.InputTag('analysisPatJetsAK5PF')
#----------------------------------------------------------------------------------------------------
