...
process.source = cms.Source ("PoolSource",
                             ...
                             skipEvents=cms.untracked.uint32(1385)
                             )
...
process.analysisPatTaus.finalCut = cms.string('pt > 1000. & abs(eta) < 2.3')
...
process.analysisPatMuons.finalCut = cms.string("isGlobalMuon & muonID('GlobalMuonPromptTight') & pt > 1000")
...
process.analysisPatElectrons.finalCut = cms.string('pt > 10000')
...
addJetCollection(process,cms.InputTag('ak5PFchsJets'),
    ...
    doBTagging   = False , # Perform b-tagging and store b-tagging info in the jet
...
process.rootTuplePFJets.InputTag = cms.InputTag('selectedPatJetsAK5PFchs')
...
process.rootTuplePFJets.InputTagSmearedUp = cms.InputTag('patJets')
process.rootTuplePFJets.InputTagSmearedDown = cms.InputTag('patJets')
process.rootTuplePFJets.InputTagScaledUp    = cms.InputTag('patJets')
process.rootTuplePFJets.InputTagScaledDown  =  cms.InputTag('patJets')
#----------------------------------------------------------------------------------------------------
