...
if RunPATMET:
  ...
  #### HACK TO CORRECT PAT MET to be same as PFMET
  new_postfix=''
  ...
  runMEtUncertainties(
    process,
    jetCollection           = cms.InputTag('selectedPatJetsPF'),
...
process.RawPFMet = patMETs.clone(
    metSource = cms.InputTag('pfMet'),
    addMuonCorrections = cms.bool(False),
    genMETSource = cms.InputTag('genMetTrue')
)

process.RawPFMet2 = patMETs.clone(
    metSource = cms.InputTag('patPFMet'),
    addMuonCorrections = cms.bool(False),
    genMETSource = cms.InputTag('genMetTrue')
)

process.PFType1MET= patMETs.clone(
...
process.p = cms.Path(
  ...
  #process.LJFilter*
    # Ru nPAT conversions for electrons                                                                                                                          
